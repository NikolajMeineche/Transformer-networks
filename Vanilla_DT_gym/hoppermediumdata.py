...
dfori = pd.DataFrame(datahopperoriginal)
...
dfhopperemb32 = pd.concat([dfori,dfhopperemb32], ignore_index=True)
...
dfhoppermaxbudget = pd.concat([dfori,dfhoppermaxbudget], ignore_index=True)
...
dfhoppercontext = pd.concat([dfori,dfcontextlength])



print(dfhoppercontext)
